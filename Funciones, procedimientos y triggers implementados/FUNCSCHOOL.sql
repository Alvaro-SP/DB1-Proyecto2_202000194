...
CREATE FUNCTION ValidarCorreo(correo VARCHAR(45)) RETURNS BOOLEAN
    ...
    IF (SELECT REGEXP_INSTR(correo, '(\w+@\w+(\.\w+)+)')) =1 THEN
...
CREATE FUNCTION RegistrarEstudiante
    ...
    END//
DELIMITER ;
SELECT RegistrarEstudiante(2020001942,'Alvaro', 'Socop', '2001-12-24','gvg@gmail.com',55555555,'mlsw calle juan', 3034161730108,14 );
